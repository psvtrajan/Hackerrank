 ...
 * The syntax is printf("format string",argument_list);. In the function,     *
 * if we are using an integer, character, string or float as argument, then   *
 * in the format string we have to write %d (integer), %c (character),        *
 * %s (string), %f (float) respectively.                                      *
 *                                                                            *
 * The scanf() function reads the input data from the console. The syntax     *
 * is scanf("format string",argument_list);. For ex: The scanf("%d",&number)  *
 * statement reads integer number from the console and stores the given       *
 * value in variable number.                                                  *
 *                                                                            *
 ...
 * the first line, and the sum and difference of both float (scaled to 1      *
